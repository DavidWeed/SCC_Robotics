  /* Geofence Reentry Test 4/20/18
   *  David Weed & Brian Choi 
   *  
   * Sheldon should exit the geofence and reenter by turning  
  */
...
{  
  ...
  if(getInches(frontPing) < 120)
  {
    drive.write(90);
    //save GPS location
    delay(2000);                                        //Sheldon visibly acknowledges there is something in front of him
    front_steer.write(90 - (int)atan(1.25/radius));     //Sheldon turns left 
  ...
  else if(getInches(leftPing) < 120)
  {
    drive.write(90);
    //save GPS location
    delay(2000);                                        //Sheldon visibly acknowledges there is something to the left of him
    front_steer.write(90 + (int)atan(1.25/radius));     //Sheldon turns right 
    gps_delay(timeToTurn);
    front_steer.write(90);
  }
  else if(getInches(rightPing) < 120)
  {
    drive.write(90);
    //save GPS location
    delay(2000);                                        //Sheldon visibly acknowledges there is something to the right of him
    front_steer.write(90 - (int)atan(1.25/radius));     //Sheldon turns left 
    gps_delay(timeToTurn);
    front_steer.write(90);
  }
